...
export const Background = styled.div`
  ...
  background: /*linear-gradient(to bottom, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.35)), TODO: gradients*/ url(${({ src }) => (src ? `../images/misc/${src}.jpg` : '../images/misc/home-bg.jpg')}) ${props => props.theme.header.BGPosition} / cover no-repeat;
